...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"나눔고딕", 9));
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"나눔고딕", 9));
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"나눔고딕", 9));
